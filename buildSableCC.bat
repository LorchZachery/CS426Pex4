...
rem
java -jar "C:\Users\Cadet_Admin\OneDrive - afacademy.af.edu\current_school\CS426\sablecc-3-beta.3.altgen.20041114\lib\sablecc.jar" -t csharp,csharp-build grammar.txt
pause
